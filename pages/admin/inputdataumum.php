                ...
                <form action="" method="POST">
                   ...
                   <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="radio" class="rounded-circle h-100" id="pic" name="pic" style="margin-left: 0%;" value="Umum">
                            <span style="position: absolute; padding-top: 6px; margin-left: 1%;">Umum</span>
                        </div>
                    </div>
