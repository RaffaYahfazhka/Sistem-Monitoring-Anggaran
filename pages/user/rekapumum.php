    ...
    <section class="home" style="width: 94.5%; height: auto;">
        <div class="card-header">
            ...
            <div class="dropdown">
                ...
                <img src="../../assets/img/user.png" id="imgprofile" alt="Profile Picture" style="position: absolute; left: 920px; top: -25px; width:40px; height:40px; cursor: pointer; border-radius: 50px;">
